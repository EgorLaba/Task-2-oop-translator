...
# Ниже обозначен вывод, который должен быть в консоли, если класс реализован правильно

# {'Hello': 'Привет', 'Morning': 'Утро', 'Car': 'Автомобиль', 'Truck': 'Грузовик'}
# {'Автомобиль': 'Car', 'Вечер': 'Evening', 'Грузовик': 'Truck', 'Платье': 'Dress'}
# {'Грузовик': 'Грузавік', 'Утро': 'Раніца'}
# {'Утро': 'Раніца'}
# Словарь должен быть типа <dict>
# {'Утро': 'Раніца'}
# Hello -> Привет
# Truck -> Грузовик
# Для слова 'Грузовик' перевода нет
# Утро -> Раніца
# Вечер -> Evening
# Платье -> Dress
